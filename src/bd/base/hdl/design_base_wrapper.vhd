...
end design_base_wrapper;

architecture STRUCTURE of design_base_wrapper is
  component design_base is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
design_base_i: component design_base
     port map (
      ...
      rpi_gpio(19 downto 0) => rpi_gpio(19 downto 0),
