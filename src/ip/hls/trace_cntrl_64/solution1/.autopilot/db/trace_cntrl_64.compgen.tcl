...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 18 \
			corename trace_cntrl_64_trace_cntrl_axilite \
			name trace_cntrl_64_trace_cntrl_s_axi \
			ports {$port_trace_cntrl} \
			op interface \
		...
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'trace_cntrl'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler trace_cntrl_64_trace_cntrl_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { trace_64_TDATA { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { trace_64_TVALID { I 1 bit } trace_64_TREADY { O 1 bit } trace_64_TDEST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { capture_64_TDATA { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { capture_64_TVALID { O 1 bit } capture_64_TREADY { I 1 bit } capture_64_TDEST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 33
set RegSliceName trace_cntrl_64_regslice_both
set RegSliceInstName trace_cntrl_64_regslice_both_U
set CoreName ap_simcore_trace_cntrl_64_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
