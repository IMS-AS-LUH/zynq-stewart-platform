...
attribute shreg_extract : string;
    ...
    signal trunc_ln674_fu_123_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln674_reg_223 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln232_1_fu_149_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln232_fu_146_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln232_3_fu_162_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln232_2_fu_159_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal out_c1_V_fu_153_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal out_c2_V_fu_166_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_1_fu_186_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln674_5_fu_182_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_172_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((stream_in_24_TVALID = ap_const_logic_0) or (ap_start_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                ...
                tmp_3_reg_213 <= stream_in_24_TDATA(15 downto 8);
                tmp_5_reg_218 <= stream_in_24_TDATA(23 downto 16);
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_CS_fsm_state2, stream_in_24_TVALID, stream_out_32_TREADY, tmp_last_V_fu_134_p1)
    begin
        if ((not(((stream_out_32_TREADY = ap_const_logic_0) or (stream_in_24_TVALID = ap_const_logic_0))) and (tmp_last_V_fu_134_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_fu_103_p4 <= stream_in_24_TDATA(15 downto 8);
    grp_fu_113_p4 <= stream_in_24_TDATA(23 downto 16);
    out_c1_V_fu_153_p2 <= std_logic_vector(unsigned(zext_ln232_1_fu_149_p1) + unsigned(zext_ln232_fu_146_p1));
    out_c2_V_fu_166_p2 <= std_logic_vector(unsigned(zext_ln232_3_fu_162_p1) + unsigned(zext_ln232_2_fu_159_p1));
    ...
    stream_out_32_TDATA <= (((tmp_1_fu_186_p4 & trunc_ln674_5_fu_182_p1) & tmp_s_fu_172_p4) & trunc_ln674_reg_223);
    ...
    stream_out_32_TUSER <= (stream_in_24_TUSER or empty_reg_208_3);
    ...
    tmp_1_fu_186_p4 <= out_c2_V_fu_166_p2(8 downto 1);
    tmp_last_V_fu_134_p1 <= stream_in_24_TLAST;
    tmp_s_fu_172_p4 <= out_c1_V_fu_153_p2(8 downto 1);
    trunc_ln674_5_fu_182_p1 <= stream_in_24_TDATA(8 - 1 downto 0);
    trunc_ln674_fu_123_p1 <= stream_in_24_TDATA(8 - 1 downto 0);
    zext_ln232_1_fu_149_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_103_p4),9));
    zext_ln232_2_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_5_reg_218),9));
    zext_ln232_3_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_113_p4),9));
    zext_ln232_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_3_reg_213),9));
end behav;
