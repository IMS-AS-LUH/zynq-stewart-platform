...
always @ (*) begin
    if ((~((stream_out_32_TREADY == 1'b0) | (stream_in_24_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (tmp_last_V_fu_102_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign tmp_last_V_fu_102_p1 = stream_in_24_TLAST;
