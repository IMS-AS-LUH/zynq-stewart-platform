...
reg   [7:0] p_Result_6_reg_172;
wire   [7:0] p_Result_7_fu_126_p4;
reg   [7:0] p_Result_7_reg_177;
reg   [7:0] p_Result_9_reg_182;
wire   [23:0] p_Result_s_fu_140_p3;
wire   [23:0] p_Result_1_fu_159_p4;
wire   [15:0] trunc_ln414_fu_136_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((~((stream_in_32_TVALID == 1'b0) | (stream_out_24_TREADY == 1'b0) | (ap_start_int == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_Result_6_reg_172 <= {{stream_in_32_TDATA[15:8]}};
        p_Result_7_reg_177 <= {{stream_in_32_TDATA[31:24]}};
        p_Result_9_reg_182 <= {{stream_in_32_TDATA[23:16]}};
...
always @ (*) begin
    if (((tmp_last_V_reg_167 == 1'd1) & (stream_out_24_TREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign p_Result_1_fu_159_p4 = {{{p_Result_7_reg_177}, {p_Result_6_reg_172}}, {p_Result_9_reg_182}};

assign p_Result_7_fu_126_p4 = {{stream_in_32_TDATA[31:24]}};

assign p_Result_s_fu_140_p3 = {{p_Result_7_fu_126_p4}, {trunc_ln414_fu_136_p1}};

assign stream_out_24_TKEEP = 3'd0;

assign stream_out_24_TSTRB = 3'd0;

assign trunc_ln414_fu_136_p1 = stream_in_32_TDATA[15:0];
