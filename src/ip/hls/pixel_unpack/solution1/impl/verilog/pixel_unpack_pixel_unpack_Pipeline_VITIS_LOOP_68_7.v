...
reg   [15:0] p_Result_2_reg_134;
wire   [23:0] zext_ln414_fu_110_p1;
wire   [23:0] zext_ln414_1_fu_125_p1;
wire   [15:0] p_Result_s_fu_106_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((~((stream_in_32_TVALID == 1'b0) | (stream_out_24_TREADY == 1'b0) | (ap_start_int == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_Result_2_reg_134 <= {{stream_in_32_TDATA[31:16]}};
...
always @ (*) begin
    if (((tmp_last_V_reg_129 == 1'd1) & (stream_out_24_TREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign p_Result_s_fu_106_p1 = stream_in_32_TDATA[15:0];

assign stream_out_24_TKEEP = 3'd0;

assign stream_out_24_TSTRB = 3'd0;

assign zext_ln414_1_fu_125_p1 = p_Result_2_reg_134;

assign zext_ln414_fu_110_p1 = p_Result_s_fu_106_p1;
