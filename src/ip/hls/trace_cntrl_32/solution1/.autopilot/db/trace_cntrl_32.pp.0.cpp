# 1 "trace_cntrl_32/trace_cntrl_32.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "trace_cntrl_32/trace_cntrl_32.cpp" 2
...
# 6 "trace_cntrl_32/trace_cntrl_32.cpp" 2




typedef ap_axis<32,1,1,1> word;
typedef hls::stream<word> axis;


__attribute__((sdx_kernel("trace_cntrl_32", 0))) void trace_cntrl_32(axis& trace_32,
                    axis& capture_32,
                    ap_int<32> trigger, int length) {
#line 11 "C:/Users/Sebastian/Documents/Studium/Master/HwP/PYNQ/boards/ip/hls/trace_cntrl_32/script.tcl"
#pragma HLSDIRECTIVE TOP name=trace_cntrl_32
# 16 "trace_cntrl_32/trace_cntrl_32.cpp"
...
word trace_temp;
 ...
 match = false;
 VITIS_LOOP_28_1: for ( i = 0 ; i<length ;i++) {
#pragma HLS pipeline
