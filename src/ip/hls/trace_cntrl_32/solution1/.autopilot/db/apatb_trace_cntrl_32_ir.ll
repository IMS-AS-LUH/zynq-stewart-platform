; ModuleID = 'C:/Users/Sebastian/Documents/Studium/Master/HwP/PYNQ/boards/ip/hls/trace_cntrl_32/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_trace_cntrl_32_ir(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %trace_32, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %capture_32, %"struct.ap_int<32>"* nocapture readonly %trigger, i32 %length) local_unnamed_addr #0 {
entry:
  %trace_32_copy.data = alloca i32
  %trace_32_copy.keep = alloca i4
  %trace_32_copy.strb = alloca i4
  %trace_32_copy.user = alloca i1
  %trace_32_copy.last = alloca i1
  %trace_32_copy.id = alloca i1
  %trace_32_copy.dest = alloca i1
  %capture_32_copy.data = alloca i32
  %capture_32_copy.keep = alloca i4
  %capture_32_copy.strb = alloca i4
  %capture_32_copy.user = alloca i1
  %capture_32_copy.last = alloca i1
  %capture_32_copy.id = alloca i1
  %capture_32_copy.dest = alloca i1
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* nonnull %trace_32, i32* %trace_32_copy.data, i4* %trace_32_copy.keep, i4* %trace_32_copy.strb, i1* %trace_32_copy.user, i1* %trace_32_copy.last, i1* %trace_32_copy.id, i1* %trace_32_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* nonnull %capture_32, i32* %capture_32_copy.data, i4* %capture_32_copy.keep, i4* %capture_32_copy.strb, i1* %capture_32_copy.user, i1* %capture_32_copy.last, i1* %capture_32_copy.id, i1* %capture_32_copy.dest)
  call void @apatb_trace_cntrl_32_hw(i32* %trace_32_copy.data, i4* %trace_32_copy.keep, i4* %trace_32_copy.strb, i1* %trace_32_copy.user, i1* %trace_32_copy.last, i1* %trace_32_copy.id, i1* %trace_32_copy.dest, i32* %capture_32_copy.data, i4* %capture_32_copy.keep, i4* %capture_32_copy.strb, i1* %capture_32_copy.user, i1* %capture_32_copy.last, i1* %capture_32_copy.id, i1* %capture_32_copy.dest, %"struct.ap_int<32>"* %trigger, i32 %length)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %trace_32, i32* %trace_32_copy.data, i4* %trace_32_copy.keep, i4* %trace_32_copy.strb, i1* %trace_32_copy.user, i1* %trace_32_copy.last, i1* %trace_32_copy.id, i1* %trace_32_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %capture_32, i32* %capture_32_copy.data, i4* %capture_32_copy.keep, i4* %capture_32_copy.strb, i1* %capture_32_copy.user, i1* %capture_32_copy.last, i1* %capture_32_copy.id, i1* %capture_32_copy.dest)
  ret void
}
...
declare void @apatb_trace_cntrl_32_hw(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, %"struct.ap_int<32>"*, i32)
...
define void @trace_cntrl_32_hw_stub_wrapper(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, %"struct.ap_int<32>"*, i32) #5 {
entry:
  %16 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"
  %17 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %16, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %17, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  call void @trace_cntrl_32_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %16, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %17, %"struct.ap_int<32>"* %14, i32 %15)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %16, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %17, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  ret void
}

declare void @trace_cntrl_32_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"*, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"*, %"struct.ap_int<32>"*, i32)
