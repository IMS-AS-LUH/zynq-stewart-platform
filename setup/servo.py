...
# Servo limits for each servo. Use "Servo Setup.ipynb" to find
...
# This determins the order the calculated angles are sorted
# to the servos. The key is the angle position and the 
# value is the serve that is set to the angle.
servo_reorder_map = {
    0 : 0,
    1 : 2,
    2 : 5,
